...
def encontrar_ciclos(perm): #perm es una lista que representa una permutación de índices
    """
    Encuentra los ciclos en una permutación y los representa en notación cíclica.

    Args:
        perm (list): Una lista que representa una permutación de índices.

    Returns:
        list: Una lista de ciclos, donde cada ciclo es una lista de índices ajustados para que arranquen desde 1.
    """
    n = len(perm)
    ...
    return ciclos # Retorna la lista de ciclos
...
def permutaciones(G1, G2, q):
    ...
    for perm in permutations(range(n)):
        ...
        if np.array_equal(G1_permutada, G2):
            ...
            return permutaciones_posiciones, intercambios
    return False, None
